...
window.App = class App {
    ...
    showWelcomeMessage() {
        ...
        if (isFirstVisit) {
            ...
            setTimeout(() => {
                window.UI.showToast('Добро пожаловать в Flappy Bird Enhanced! 🐦', 'success', 4000);
            }, 1000);
            
            // Показываем краткую инструкцию
            setTimeout(() => {
                window.UI.showToast('Нажмите SPACE или коснитесь экрана для прыжка', 'info', 4000);
            }, 3000);
        } else {
            ...
            if (lastScore > 0) {
                setTimeout(() => {
                    window.UI.showToast(`С возвращением! Ваш рекорд: ${lastScore}`, 'info', 3000);
                }, 500);
            }
        }
    }
